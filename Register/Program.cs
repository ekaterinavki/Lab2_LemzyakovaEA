...
public class Register
{
    ...
    public static (string, string) CheckLoginLength(string login)
    {
    ...
    public static (string, string) CheckExistUser(string login)
    {
    ...
    public static (string, string) CheckLoginContent(string login)
    {
    ...
    public static (string, string) CheckPasswordLength(string password)
    {
    ...
    public static (string, string) CheckPasswordEquality(string password, string password2)
    {
    ...
    public static (string, string) CheckPasswordContent(string password)
    {
